public class FuncionarioRisco{
    public static final double LIM_ISENCAO_IR = 2000;
    private String matricula;
    private String nome;
    private double salarioBruto;
    
    public FuncionarioRisco(String matricula, String nome, double salarioBruto){
    ...
    public double getAdicional(){
        return ( this.salarioBruto -getINSS() ) * 0.25;
    }
    ...
    public String toString() {
        ...
        aux += "(-) Insalubridade: "+this.getAdicional()+"\n";
